...
const SAMPLE_BONUS_SECTIONS = [
    {
        ...
        icon_name: 'Gift',
        description: 'Boost your bankroll right from the start. Claim match bonuses up to 500% plus hundreds of free spins on your initial deposits.',
        sort_order: 1,
        offers: [
            {
    ...
    },
    {
        ...
        icon_name: 'Sparkles',
        description: 'Test top online slots completely free without risking your own money. Sign up, verify your account, and start spinning immediately.',
        sort_order: 2,
        offers: [
            {
    ...
    },
    {
        ...
        icon_name: 'Coins',
        description: 'Get massive crypto match percentages with BTC, ETH, USDT, LTC, and more. Enjoy instant withdrawals and anonymous gameplay.',
        sort_order: 3,
        offers: [
            {
    ...
    },
    {
        ...
        icon_name: 'Percent',
        description: 'Recover up to 25% of your weekly net losses as real, wager-free cash. Plus weekly reload deposit matches every Friday & weekend.',
        sort_order: 4,
        offers: [
            {
    ...
    },
    {
        ...
        badge_text: 'VIP Only',
        icon_name: 'Flame',
        description: 'Exclusive high-stakes bonuses with personal VIP account managers, higher betting limits, tailored cashback, and expedited limits.',
        sort_order: 5,
        offers: [
            {
...
async function seedBonusSections() {
    ...
    for (const sectionData of SAMPLE_BONUS_SECTIONS) {
        ...
        const createdSection = await prisma.bonusSection.create({
            data: {
...
//# sourceMappingURL=seedBonusSections.js.map